...
const vertexShaderSource:string = (() => require("./glsl/2d-vertex-shader.glsl"))();
const fragmentShaderSource:string = (() => require("./glsl/2d-fragment-shader.glsl"))();
...
class Renderer implements IRenderable {
    ...
    private addGLProperties(): void {
        if (this.gl) {
            ...
            const mousePosition: WebGLUniformLocation | null = this.gl.getUniformLocation(this.program, "mouse");
